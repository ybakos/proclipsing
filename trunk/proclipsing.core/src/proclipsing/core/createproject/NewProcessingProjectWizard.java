...
public class NewProcessingProjectWizard extends Wizard implements INewWizard {
	...
	public void setConfiguration(String name, String appPath,
			String sketchPath, ArrayList<String> baselibs, ArrayList<String> userlibs, boolean isApp) {
		preferences = new ProjectPreferences(name, appPath, sketchPath, baselibs, userlibs);
		this.isApp = isApp;
	}
